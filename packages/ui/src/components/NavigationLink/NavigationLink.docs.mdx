...
import * as NavigationLinkStories from './NavigationLink.stories'

<Meta title="SwiftUI/NavigationLink/Readme" />
...
<Canvas of={NavigationLinkStories.Default} />

### Navigate to External URL

<Canvas of={NavigationLinkStories.ExternalURL} />
...
<Canvas of={NavigationLinkStories.ActionSheet} />
...
- [NavigationStack](/docs/components/navigationstack) - Container for navigation
- [StandardPage](/docs/components/page/standard-page/standardpage) - Default page container
