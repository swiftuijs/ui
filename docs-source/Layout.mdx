...
```tsx
// ✅ Good: Use VStack for vertical list
<VStack>
  <Item />
  <Item />
</VStack>
...
```tsx
// ✅ Good: Use Spacer for flexible layout
<HStack>
  <Text>Left</Text>
  <Spacer />
  <Text>Right</Text>
...
- 📱 Learn about [Responsive Design](/docs/Responsive) to create adaptive layouts
- 🎨 Check out [Theming](/docs/Theming) to customize styles
