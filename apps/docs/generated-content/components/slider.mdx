---
title: "Slider"
description: "Slider is a control for selecting a value from a bounded linear range of values. Slider is built on a native `<input type=\"range\">`, so it keeps standard keyboard support, focus behavior, and form participation."
---
