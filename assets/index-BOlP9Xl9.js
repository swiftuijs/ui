import{r as d,j as s,R as V}from"../vite-inject-mocker-entry.js";import{B as F,L as H,u as q,E as R,a as _,b as E,i as G,e as w,v as U,N as A,V as W}from"./index-BwVA9Lg1.js";import{s as g,p as a,a as Z,g as C}from"./standardize-umhyi7Fb.js";import{H as S}from"./index-B2-CykP2.js";import{T as P}from"./index-BNcsCq3F.js";function Y(){return typeof document<"u"&&"startViewTransition"in document}class K{static getTransitionMode(e){return!e||!e.type?"css":e.type==="view-transition"&&Y()?"view-transition":"css"}static applyTransitionConfig(e,t){if(t&&(t.viewTransitionName?e.style.viewTransitionName=t.viewTransitionName:e.style.viewTransitionName="",t.duration||t.easing)){const n=t.duration?`${t.duration}ms`:void 0,o=t.easing;(n||o)&&(e.style.transition=[n?`all ${n}`:void 0,o||void 0].filter(Boolean).join(" "))}}static getDefaultTransition(e){return e==="actionsheet"?{type:"fade",duration:200}:{type:"slide",duration:300,easing:"cubic-bezier(0.075, 0.82, 0.165, 1)"}}static mergeTransitionConfig(e,t){return!e&&!t?{type:"slide"}:e?t?{...t,...e,direction:e.direction??t.direction}:e:t}}const X=d.memo(function(e){const{alignment:t,...n}=e;return s.jsx(F,{alignment:t,stackClassName:"zstack",...n})});X.__docgenInfo={description:"",methods:[],displayName:"ZStack",props:{alignment:{required:!1,tsType:{name:"EAlignment"},description:`The alignment of the children within the ZStack.
...
@default ['medium', 'large']`},type:{required:!0,tsType:{name:"literal",value:"'actionsheet'"},description:"The page type. Must be 'actionsheet' for ActionSheet component."}},composes:["IPageBaseComponent"]};const j=class j extends d.Component{constructor(e){super(e),this.containerRef=V.createRef(),this.pageType=e.type||"page",console.log("[page] created",this.pageType,this.props.id)}componentDidMount(){if(!this.containerRef.current)return;const e=this.containerRef.current;if(this.props.noEnteringAnimation){w.emit(`${this.context.eventPrefix}.page-entered`,this.props.id);return}const t=()=>{w.emit(`${this.context.eventPrefix}.page-entered`,this.props.id),e.removeEventListener("animationend",t)};e.addEventListener("animationend",t),e.setAttribute("date-page-status","entering")}shouldComponentUpdate(e){return this.props.id!==e.id||this.props.type!==e.type}UNSAFE_componentWillUpdate(e){console.log("[page] update",this.pageType,this.props.id),console.log("[page] previous",this.props,"nextProps",e)}render(){console.log("[page] render",this.pageType,this.props.id);const{noEnteringAnimation:e,transition:t,...n}=this.props;return this.pageType==="actionsheet"?s.jsx(M,{...n,type:"actionsheet",ref:this.containerRef}):s.jsx($,{...n,type:"page",ref:this.containerRef,transition:t})}exitPage(e){if(!this.containerRef.current)return;const t=this.containerRef.current,n=()=>{t.removeEventListener("animationend",n),e&&e()};t.addEventListener("animationend",n),t.setAttribute("date-page-status","exiting")}};j.contextType=A;let I=j;I.__docgenInfo={description:`A container view that represents a single page in a navigation hierarchy.
...
@default 0`}},composes:["IBaseComponent"]};const ve=d.memo(function(e){const{commonProps:t,restProps:n,children:o}=g(e,{className:a("group")});return s.jsx("div",{...t,...n,children:o})});ve.__docgenInfo={description:"",methods:[],displayName:"Group"};const ye=d.memo(function(e){const{label:t,...n}=e,{commonProps:o,restProps:i,children:r}=g(n,{className:a("groupbox")});return s.jsxs("div",{...o,...i,children:[t&&s.jsx("div",{className:a("groupbox-label"),children:t}),s.jsx("div",{className:a("groupbox-content"),children:r})]})});ye.__docgenInfo={description:"",methods:[],displayName:"GroupBox",props:{label:{required:!1,tsType:{name:"string"},description:"Optional label for the group box."}},composes:["IBaseComponent"]};const be=d.memo(function(e){const{commonProps:t,restProps:n,children:o}=g(e,{className:a("card")});return s.jsx("div",{...t,...n,children:o})});be.__docgenInfo={description:"",methods:[],displayName:"Card"};const xe=d.memo(function(e){const{label:t,defaultExpanded:n=!1,expanded:o,onExpandedChange:i,...r}=e,[c,p]=d.useState(n),u=o!==void 0,m=u?o:c,f=()=>{const T=!m;u||p(T),i?.(T)},{commonProps:y,restProps:x,children:b}=g(r,{className:[a("disclosuregroup"),m&&a("disclosuregroup-expanded")]});return s.jsxs("div",{...y,...x,children:[s.jsxs("button",{type:"button",className:a("disclosuregroup-toggle"),onClick:f,"aria-expanded":m,children:[s.jsx("span",{className:a("disclosuregroup-label"),children:t}),s.jsx("span",{className:a("disclosuregroup-icon"),children:m?"▼":"▶"})]}),m&&s.jsx("div",{className:a("disclosuregroup-content"),children:b})]})});xe.__docgenInfo={description:"",methods:[],displayName:"DisclosureGroup",props:{label:{required:!0,tsType:{name:"string"},description:"The label for the disclosure toggle."},defaultExpanded:{required:!1,tsType:{name:"boolean"},description:`Whether the group is initially expanded.

@default false`},expanded:{required:!1,tsType:{name:"boolean"},description:`Controlled expanded state.
If provided, the component becomes controlled.`},onExpandedChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Callback fired when the expanded state changes."}},composes:["IBaseComponent"]};const Te=d.memo(function(e){const{title:t,message:n,isVisible:o,onDismiss:i,buttons:r=[{label:"OK",action:i}],...c}=e;if(!o)return null;const{commonProps:p,restProps:u}=g(c,{className:a("alert")});return s.jsxs(s.Fragment,{children:[s.jsx("div",{className:a("alert-backdrop"),onClick:i}),s.jsx("div",{...p,...u,children:s.jsxs("div",{className:a("alert-content"),children:[s.jsx("div",{className:a("alert-title"),children:t}),n&&s.jsx("div",{className:a("alert-message"),children:n}),s.jsx("div",{className:a("alert-actions"),children:r.map((m,f)=>s.jsx("button",{type:"button",className:[a("alert-button"),a(`alert-button-${m.style||"default"}`)].join(" "),onClick:m.action,children:m.label},f))})]})})]})});Te.__docgenInfo={description:"",methods:[],displayName:"Alert",props:{title:{required:!0,tsType:{name:"string"},description:"The title of the alert."},message:{required:!1,tsType:{name:"string"},description:"The message body of the alert."},isVisible:{required:!0,tsType:{name:"boolean"},description:"Whether the alert is visible."},onDismiss:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback fired when the alert should be dismissed."},buttons:{required:!1,tsType:{name:"Array",elements:[{name:"IAlertButton"}],raw:"IAlertButton[]"},description:"The buttons to display in the alert."}},composes:["IBaseComponent"]};function we(l){const{children:e,...t}=l,n=d.useRef(null),[o,i]=d.useState({width:0,height:0,x:0,y:0});d.useEffect(()=>{const p=n.current;if(!p)return;const u=()=>{const f=p.getBoundingClientRect();i({width:f.width,height:f.height,x:f.x,y:f.y})};u();const m=new ResizeObserver(u);return m.observe(p),window.addEventListener("resize",u),window.addEventListener("scroll",u,{passive:!0}),()=>{m.disconnect(),window.removeEventListener("resize",u),window.removeEventListener("scroll",u)}},[]);const{commonProps:r,restProps:c}=g(t,{className:[a("geometry-reader")]});return s.jsx("div",{...r,...c,ref:n,children:e(o)})}we.__docgenInfo={description:`A view that provides geometry information to its children.
...
@returns React node`}},composes:["Omit"]};const Ne=d.memo(function(e){const{onSubmit:t,isValid:n,...o}=e,i=p=>{p.preventDefault(),t&&t(p)},{commonProps:r,restProps:c}=g(o,{className:[a("form")]});return s.jsx("form",{...r,...c,onSubmit:i,noValidate:n===!1})});Ne.__docgenInfo={description:`A container for grouping form controls.
...
@param event - Form submit event`},isValid:{required:!1,tsType:{name:"boolean"},description:"Form validation state"}},composes:["IBaseComponent"]};const Ie=d.memo(function(e){const{items:t,initialIndex:n=0,selectedIndex:o,onSelectionChange:i,tabBarPosition:r="bottom",...c}=e,[p,u]=d.useState(n),m=o!==void 0,f=m?o:p,y=v=>{m||u(v),i&&i(v)},{commonProps:x,restProps:b}=g(c,{className:[a("tab-view"),r==="top"?a("tab-view-top"):a("tab-view-bottom")]}),T=t[f]?.content;return s.jsxs("div",{...x,...b,children:[r==="top"&&s.jsx("div",{className:a("tab-bar"),children:t.map((v,h)=>s.jsxs("button",{className:`${a("tab-item")} ${f===h?a("tab-item-active"):""}`,onClick:()=>y(h),type:"button",children:[v.icon&&s.jsx("span",{className:a("tab-icon"),children:v.icon}),s.jsx("span",{className:a("tab-label"),children:v.label})]},v.id||h))}),s.jsx("div",{className:a("tab-content"),children:T}),r==="bottom"&&s.jsx("div",{className:a("tab-bar"),children:t.map((v,h)=>s.jsxs("button",{className:`${a("tab-item")} ${f===h?a("tab-item-active"):""}`,onClick:()=>y(h),type:"button",children:[v.icon&&s.jsx("span",{className:a("tab-icon"),children:v.icon}),s.jsx("span",{className:a("tab-label"),children:v.label})]},v.id||h))})]})});Ie.__docgenInfo={description:`A view that switches between multiple child views using interactive tabs.
...
@default 'bottom'`}},composes:["IBaseComponent"]};const Pe=d.forwardRef(function(e,t){const{isPresented:n,onDismiss:o,presentationStyle:i="pageSheet",showDragIndicator:r=!0,children:c,...p}=e;if(!n)return null;const u=y=>{y.target===y.currentTarget&&o&&o()},{commonProps:m,restProps:f}=g(p,{className:[a("sheet"),a(`sheet-${i}`)]});return s.jsx("div",{className:a("sheet-backdrop"),onClick:u,children:s.jsxs("div",{...m,...f,ref:t,role:"dialog","aria-modal":"true",children:[r&&i!=="fullScreen"&&s.jsx("div",{className:a("sheet-drag-indicator")}),s.jsx("div",{className:a("sheet-content"),children:c})]})})});Pe.__docgenInfo={description:`A view that presents content as a modal sheet.
...
@default true`}},composes:["IBaseComponent"]};function Se(l){const{items:e,trigger:t,placement:n="bottom",isOpen:o,onOpenChange:i,...r}=l,[c,p]=d.useState(!1),u=d.useRef(null),m=d.useRef(null),f=o!==void 0,y=f?o:c,x=()=>{const h=!y;f||p(h),i&&i(h)},b=h=>{h.disabled||(h.action&&h.action(),f||p(!1),i&&i(!1))};d.useEffect(()=>{if(!y)return;const h=N=>{u.current&&m.current&&!u.current.contains(N.target)&&!m.current.contains(N.target)&&(f||p(!1),i&&i(!1))};return document.addEventListener("mousedown",h),()=>{document.removeEventListener("mousedown",h)}},[y,f,i]);const{commonProps:T,restProps:v}=g(r,{className:[a("menu-container")]});return s.jsxs("div",{...T,...v,children:[s.jsx("div",{ref:m,onClick:x,className:a("menu-trigger"),children:t}),y&&s.jsx("div",{ref:u,className:`${a("menu")} ${a(`menu-${n}`)}`,children:e.map((h,N)=>s.jsxs("div",{className:`${a("menu-item")} ${h.disabled?a("menu-item-disabled"):""}`,onClick:()=>b(h),children:[h.icon&&s.jsx("span",{className:a("menu-item-icon"),children:h.icon}),s.jsx("span",{className:a("menu-item-label"),children:h.label}),h.submenu&&s.jsx("span",{className:a("menu-item-arrow"),children:"›"})]},h.id||N))})]})}Se.__docgenInfo={description:`A view that displays a menu of options.
...
@see https://developer.apple.com/documentation/swiftui/toolbar`,methods:[],displayName:"Toolbar",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"IToolbarItem"}],raw:"IToolbarItem[]"},description:"Toolbar items"}},composes:["IBaseComponent"]};const Ce=d.memo(function(e){const{children:t,variant:n="default",style:o,...i}=e,{commonProps:r,restProps:c}=g({...i,style:o},{className:[a("badge"),a(`badge-${n}`)]});return s.jsx("div",{...r,...c,children:t})});Ce.__docgenInfo={description:`A view that displays a badge.
...
@default 'default'`},style:{required:!1,tsType:{name:"IBaseComponent['style']",raw:"IBaseComponent['style']"},description:"Custom CSS style (overrides variant)"}},composes:["Omit"]};const je=d.memo(function(e){const{value:t="",onChange:n,placeholder:o,minLines:i=1,maxLines:r,disabled:c=!1,...p}=e,u=x=>{n&&n(x.target.value)},{commonProps:m,restProps:f}=g(p,{className:[a("text-editor")]}),y=r?Math.min(Math.max(t.split(`
`).length,i),r):Math.max(t.split(`
`).length,i);return s.jsx("textarea",{...m,...f,value:t,onChange:u,placeholder:o,rows:y,disabled:c})});je.__docgenInfo={description:`A view that displays and edits multiline text.
...
@default 1`},maxLines:{required:!1,tsType:{name:"number"},description:"Maximum number of lines"},disabled:{required:!1,tsType:{name:"boolean"},description:"Whether the editor is disabled"}},composes:["Omit"]};const Re=d.memo(function(e){const{edges:t=["top","bottom","left","right"],children:n,...o}=e,{commonProps:i,restProps:r}=g(o,{className:[a("safe-area"),...t.map(c=>a(`safe-area-${c}`))]});return s.jsx("div",{...i,...r,children:n})});Re.__docgenInfo={description:`A view that insets its content to respect safe area boundaries.
...
@default ['top', 'bottom', 'left', 'right']`}},composes:["IBaseComponent"]};const _e=d.memo(function(e){const{color:t,...n}=e,{commonProps:o,restProps:i}=g(n,{className:[a("color")],style:{backgroundColor:t,...n.style}});return s.jsx("div",{...o,...i})});_e.__docgenInfo={description:`A view that displays a solid color.
...
@see https://developer.apple.com/documentation/swiftui/color`,methods:[],displayName:"Color",props:{color:{required:!0,tsType:{name:"string"},description:"Color value (CSS color string)"}},composes:["IBaseComponent"]};const Ee=d.memo(function(e){const{fill:t,stroke:n,strokeWidth:o=0,...i}=e,{commonProps:r,restProps:c}=g(i,{className:[a("shape"),a("shape-rectangle")],style:{backgroundColor:t,borderColor:n,borderWidth:o>0?`${o}px`:void 0,borderStyle:o>0?"solid":void 0,...i.style}});return s.jsx("div",{...r,...c})});Ee.__docgenInfo={description:`A rectangular shape.
...
@see https://developer.apple.com/documentation/swiftui/rectangle`,methods:[],displayName:"Rectangle",props:{fill:{required:!1,tsType:{name:"string"},description:"Fill color"},stroke:{required:!1,tsType:{name:"string"},description:"Stroke color"},strokeWidth:{required:!1,tsType:{name:"number"},description:"Stroke width"}},composes:["IBaseComponent"]};const Be=d.memo(function(e){const{fill:t,stroke:n,strokeWidth:o=0,cornerRadius:i=8,...r}=e,{commonProps:c,restProps:p}=g(r,{className:[a("shape"),a("shape-rounded-rectangle")],style:{backgroundColor:t,borderColor:n,borderWidth:o>0?`${o}px`:void 0,borderStyle:o>0?"solid":void 0,borderRadius:`${i}px`,...r.style}});return s.jsx("div",{...c,...p})});Be.__docgenInfo={description:`A rectangular shape with rounded corners.
...
@default 8`}},composes:["IBaseComponent"]};export{Ce as B,_e as C,Q as D,Ne as F,we as G,ce as I,de as L,Se as M,D as N,Ee as R,k as S,Ie as T,X as Z,L as a,pe as b,me as c,re as d,le as e,J as f,$ as g,Re as h,Be as i,Pe as j,je as k,ke as l};
